...
import poolAbi from "../../abi/curveV1";
...
function isValidWithdrawal(event: LogEvent, address: string, chain: ChainId): boolean {
	return isValidPool(address, chain) && (event.name === "RemoveLiquidity" || event.name === "RemoveLiquidityImbalance");
}
...
function processPoolCalls(_results: unknown[], address: string): PoolData | null {
	...
	const factory = getProtocolContractAddress(pool.chainId, SwapProtocol.CurveV1, "factory");
	if (!factory) {
		return null;
	}
	return {
...
const pools: CurvePool[] = [
	// Ethereum
	{
		...
		assets: ["0x5d3a536e4d6dbd6114cc1ead35777bab948e3643", "0x39aa39c021dfbae8fac545936693ac917d5e7563"],
		underlyingAssets: ["0x6b175474e89094c44da98b954eedeac495271d0f", "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"],
	},
	{
		chainId: 1,
	...
	},
	{
		...
		assets: ["0xeb4c2781e4eba804ce9a9803c67d0893436bb27d", "0x2260fac5e5542a773aa44fbcfedf7c193bc2c599"],
	},
	{
		chainId: 1,
	...
	},
	{
		...
		assets: ["0x0316eb71485b0ab14103307bf65a021042c6d380", "0x2260fac5e5542a773aa44fbcfedf7c193bc2c599"],
	},
	{
		chainId: 1,
	...
	},
	{
		...
		assets: ["0x056fd409e1d7a124bd7017459dfea2f387b6d5cd", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0xdf574c24545e5ffecb9a659c229253d4111d87e1", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x1c48f86ae57291f7686349f12601910bd8d470bb", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x674c6ad92fd080e4004b2312b45f796a192d27a0", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x0e2ec54fc0b509f445631bf4b91ab8168230c752", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0xe2f2a5c287993345a840db3b0845fbc70f5935a5", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x196f4727526ea7fb1e17b2071b3d8eaa38486988", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x8daebade922df735c38c80c7ebd708af50815faa", "0x075b1bb99792c9e1041ba13afef80c91a1e70fb3"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x5bc25f649fc4e26069ddf4cf4010f9f706c23831", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x5228a22e72ccc52d415ecfd199f99d0665e7733b", "0x075b1bb99792c9e1041ba13afef80c91a1e70fb3"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x9be89d2a4cd102d8fecc6bf9da793be995c22541", "0x075b1bb99792c9e1041ba13afef80c91a1e70fb3"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x8064d9ae6cdf087b1bcd5bdf3531bd5d8c537a68", "0x075b1bb99792c9e1041ba13afef80c91a1e70fb3"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0xa47c8bf37f92abed4a126bda807a7b7498661acd", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0xdb25f211ab05b1c97d595516f45794528a807ad8", "0xd71ecff9342a5ced620049e616c5035f1db98620"],
	},
	{
		chainId: 1,
		address: "0xc5424b857f758e906013f3555dad202e4bdb4567",
		assets: ["0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", "0x5e74c9036fb86bd7ecdcb084a0673efc32ea31cb"],
	},
	{
		chainId: 1,
	...
	},
	{
		...
		assets: ["0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", "0xae7ab96520de3a18e5e111b5eaab095312d7fe84"],
	},
	{
		chainId: 1,
		address: "0xeb16ae0052ed37f479f7fe63849198df1765a733",
		assets: ["0x028171bca77440897b824ca71d1c56cac55b68a3", "0x6c5024cd4f8a59110119c56f8933403a539555eb"],
		underlyingAssets: ["0x6b175474e89094c44da98b954eedeac495271d0f", "0x57ab1ec28d129707052df4df418d58a2d46d5f51"],
	},
	{
		chainId: 1,
		address: "0xa96a65c051bf88b4095ee1f2451c2a9d43f53ae2",
		assets: ["0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", "0xe95a203b1a91a908f9b9ce46459d101078c2c3cb"],
	},
	{
		chainId: 1,
	...
	},
	{
		...
		assets: ["0x514910771af9ca656af840dff83e8264ecf986ca", "0xbbc455cb4f1b9e4bfc4b73970d360c8f032efee6"],
	},
	{
		chainId: 1,
		address: "0x42d7025938bec20b69cbae5a77421082407f053a",
		assets: ["0x1456688345527be1f37e9e627da0837d6f08c925", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0xbc6da0fe9ad5f3b0d58160288917aa56653660e9", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x853d955acef822db058eb8505911ed77f175b99e", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x0000000000085d4780b73119b644ae5ecd22b376", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
			"0x0000000000085d4780b73119b644ae5ecd22b376",
			"0x6b175474e89094c44da98b954eedeac495271d0f",
			"0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
	...
	},
	{
		...
		assets: ["0x5f98805a4e8be255a32880fdec7f6728c6568ba0", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0x4fabb145d64652a948d72533023f6e7a623c7c53", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
			"0x4fabb145d64652a948d72533023f6e7a623c7c53",
			"0x6b175474e89094c44da98b954eedeac495271d0f",
			"0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
	...
	},
	{
		...
		assets: ["0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2", "0x9559aaa82d9649c7a7b220e7c461d2e74c9a3593"],
	},
	{
		chainId: 1,
		address: "0x5a6a4d54456819380173272a5e8e9b9904bdf41b",
		assets: ["0x99d8a9c45b2eca8864373a26d1459e3dff1e17f3", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0xc581b735a1688071a1746c968e0798d642ede491", "0xd71ecff9342a5ced620049e616c5035f1db98620"],
	},
	{
		chainId: 1,
		address: "0x618788357d0ebd8a37e763adab3bc575d54c2c7d",
		assets: ["0x03ab458634910aad20ef5f1c8ee96f1d6ac54919", "0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"],
		metapoolAssets: [
	...
	},
	{
		...
		assets: ["0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", "0xdac17f958d2ee523a2206206994597c13d831ec7"],
	},
	{
		chainId: 1,
	...
	},
	{
		...
		assets: ["0x853d955acef822db058eb8505911ed77f175b99e", "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"],
	},
	// Optimism
	{
		chainId: 10,
	...
	},
	{
		...
		assets: ["0x5c2ed810328349100a66b82b78a1791b101c9d61", "0xdbf31df14b66535af65aac99c32e9ea844e14501"],
		underlyingAssets: ["0x1bfd67037b42cf73acf2047067bd4f2c47d9bfd6", "0xdbf31df14b66535af65aac99c32e9ea844e14501"],
	},
	// Arbitrum
	{
		chainId: 42161,
	...
	},
	{
		chainId: 42161,
		address: "0x3e01dd8a5e1fb3481f0f589056b428fc308af0fb",
		assets: ["0x2f2a2543b76a4166549f7aab2e75bef0aefc5b0f", "0xdbf31df14b66535af65aac99c32e9ea844e14501"],
	},
	// Avalanche
	{
		chainId: 43114,
	...
	},
	{
		...
		assets: ["0x686bef2417b6dc32c50a3cbfbcc3bb60e1e9a15d", "0xdbf31df14b66535af65aac99c32e9ea844e14501"],
		underlyingAssets: ["0x50b7545627a5162f82a992c33b87adc75187b218", "0xdbf31df14b66535af65aac99c32e9ea844e14501"],
	},
	{
		chainId: 43114,
...
export const CurveV1Classifier: Classifiers = {
	swap: {
		type: ClassifierType.SWAP,
		protocol: Protocol.CurveV1,
		abi: poolAbi,
		isValid: isValidSwap,
		parse: parseSwap,
		pool: {
